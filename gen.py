...
a = ["Welcome to TellMe!", "I shall begin shortly!", "Your time is up.", "Momentarily, you will be moved back to the lobby, and invited to vote for the next player's prompts. The voting channel will soon appear for you.", "The round has ended, so you will be moved back to the lobby shortly.", "The round has concluded.", "I hope you enjoyed playing Tell Me. Please wait a moment while I prepare the session recording.", "Thank you for playing Tell Me, attached is the combined session recording."]
al = len(a)
